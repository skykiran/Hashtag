...
def send():
    if textReceipt.get(1.0,END)=='\n':
        ...
        def send_msg():
            ...
            auth='DYN7kZmraRywxVlu4IAJHeIfGByM42rqiOrazHXxISPcxTzjyjJfqvhoGZtE'
        ...
        numberLabel=Label(root2,text='CUSTOMER NAME',font=('arial',18,'bold underline'),bg='red4',fg='white')
        ...
        sendButton=Button(root2,text='PRINT',font=('arial',19,'italic'),bg='white',fg='red4',bd=7,relief=GROOVE
                        ,command=send_msg)
...
#Price
        priceofFood=(item1*10)+(item2*60)+(item3*100)+(item4*50)+ (item5*40) + (item6 * 40) + (item7 * 10) \
                    + (item8 * 100) + (item9 * 120)

        priceofDrinks=(item10*50)+(item11*40)+ (item12 * 80) + (item13 * 30) + (item14 * 40) + (item15 * 60) \
                    + (item16 * 20) + (item17 * 50) + (item18 * 80)

        priceofCakes=(item19*40)+(item20*30)+ (item21 * 50) + (item22 * 55) + (item23 * 45) + (item24 * 60) \
                    + (item25 * 60) + (item26 * 70) + (item27 * 60)
...
labelTitle=Label(topFrame,text='Canteen Management System',font=('Times New Roman',30,'bold'),fg='BLACK',bd=9,
                bg='RED4',width=51)
...
mutton=Checkbutton(foodFrame,text='Parotha',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var7,
                command=mutton)
mutton.grid(row=6,column=0,sticky=W)

daal=Checkbutton(foodFrame,text='Daal Fry',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var2
                ,command=daal)
daal.grid(row=1,column=0,sticky=W)

fish=Checkbutton(foodFrame,text='Fish Curry',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var3
                ,command=fish)
fish.grid(row=2,column=0,sticky=W)

sabji=Checkbutton(foodFrame,text='Veg Curry',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var4
                ,command=sabji)
...
paneer=Checkbutton(foodFrame,text='Paneer Curry',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var8
                ,command=paneer)
paneer.grid(row=7,column=0,sticky=W)

chicken=Checkbutton(foodFrame,text='Chicken Roast ',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var9
                    ,command=chicken)
...
shikanji=Checkbutton(drinksFrame,text='Shikanji',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var13
                    ,command=shikanji)
shikanji.grid(row=3,column=0,sticky=W)x``
...
labelCostofFood.grid(row=1,column=1)
...
buttonSend=Button(buttonFrame,text='PRINT',font=('arial',14,'bold'),fg='white',bg='red4',bd=3,padx=5,command=send)
